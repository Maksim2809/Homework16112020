...
public class Complex {
    ...
    /**
     * замена n-ое комплексное число на n+1-ое число
     * @param c константа для построения множества Мондельборта
     */
    public void result(Complex c){
        double Re = this.re;
        this.re = this.re*this.re - this.im*this.im + c.re;
        this.im = 2*this.im*Re+ c.im;
    }
